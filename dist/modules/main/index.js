    ...
    let Main = class Main extends components_2.Module {
        ...
        renderList(dataList) {
            ...
            dataList.forEach((product) => {
                ...
                lytItems.append(this.$render("i-grid-layout", { width: '100%', height: '100%', class: index_css_1.cardItemStyle, gap: { column: '1rem', row: '2rem' }, templateAreas: product.img ? [['areaImg'], ['areaDetails']] : [['areaDetails']], background: { color: settings.itemTransparent ? 'transparent' : settings.itemBackgroundColor || '' }, padding: { top: 16, bottom: 16 }, border: { radius: 8 } },
                    product.img ? this.$render("i-image", { class: index_css_1.imageStyle, width: ((_a = settings.itemImage) === null || _a === void 0 ? void 0 : _a.width) || 'auto', maxHeight: ((_b = settings.itemImage) === null || _b === void 0 ? void 0 : _b.height) || 100, margin: { left: ((_c = settings.itemImage) === null || _c === void 0 ? void 0 : _c.width) ? 'auto' : 0, right: ((_d = settings.itemImage) === null || _d === void 0 ? void 0 : _d.width) ? 'auto' : 0 }, padding: { top: '1rem', left: '1rem', right: '1rem' }, overflow: 'hidden', grid: { area: 'areaImg' }, url: product.img, fallbackUrl: assets_1.default.fullPath('img/placeholder.jpg') }) : [],
