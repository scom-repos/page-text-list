...
@customModule
@customElements("i-scom-feature-config")
      ...
      >
        ...
        <i-input
          ...
          onChanged={(source: Control) =>
            this.updateList(source, lastIndex, { key: "title" })
          }
        ></i-input>
        <i-hstack
          gap={8}
        ...
        >
          ...
          <i-checkbox
            ...
            height={16}
            onChanged={(source: Control) =>
              this.updateList(source, lastIndex, { key: "divider" })
            }
          ></i-checkbox>
        </i-hstack>
        ...
        <i-input
          ...
          onChanged={(source: Control) =>
            this.updateList(source, lastIndex, { key: "description" })
          }
          margin={{ bottom: 8 }}
        ></i-input>
        ...
        <i-panel margin={{ bottom: 8 }}>
          ...
          <i-input
            ...
            value={item?.imageUrl || ""}
            onChanged={(source: Control) =>
              this.updateList(source, lastIndex, { key: "imageUrl" })
            }
          ></i-input>
        </i-panel>
        ...
        >
          ...
          <i-input
            value={item?.link?.caption || ""}
            width="100%"
            onChanged={(source: Control) =>
              this.updateList(source, lastIndex, {
                key: "link",
                key2: "caption",
              })
            }
          ...
          <i-input
            ...
            width="100%"
            onChanged={(source: Control) =>
              this.updateList(source, lastIndex, { key: "link", key2: "url" })
            }
          ></i-input>
        </i-vstack>
      </i-vstack>
